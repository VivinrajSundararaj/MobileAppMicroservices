package com.appsdev.app.api.users.security;
...
import com.appsdev.app.api.users.service.UsersService;
import com.appsdev.app.api.users.shared.UserDto;
import com.appsdev.app.api.users.ui.model.LoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain,
		...
		System.out.println("Environment : token.expiration_time " + env.getProperty("token.expiration_time"));
		System.out.println("Environment : token.secret " + env.getProperty("token.secret"));
